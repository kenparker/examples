package com.maggioni.Core.Bitcount;

/**
 * http://javarevisited.blogspot.de/2014/06/how-to-count-number-of-set-bits-or-1s.html
 * @author maggioni
 */
public class CountSetBits {
    ...
    public static void main(String args[]) {
        ...
        System.out.printf("Number of set bit on %d is %d %n", 10, Integer.bitCount(10));
    ...
    /**
     * This method is not optimized, as it iterates 32 times for integer numbers in all cases, can you optimize it?
     */
    ...
    /**
     * Optimized version of previous one, loop is proportional to number of 1's instead bit size of number.
     */
